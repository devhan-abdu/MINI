         ...
         <SafeAreaView className="flex-1 bg-white px-4">
            <View>
              ...
              />
               ...
               <Pressable onPress={() => router.push('/(auth)/forgot-password')} className="text-black/60 py-6 ">
            ...
            <View style={[styles.verticallySpaced, styles.mt20]}>
             ...
             <View>
            <Pressable onPress={() => router.push('/(auth)/register')} className="text-black/60 py-6 ">
                <Text className="text-center font-medium text-black/60 text-lg">
                    {"Don't have an account yet? "}
                    <Text className="text-primary font-bold">Register</Text>
                </Text>
